...
namespace LINVAST.Imperative.Comparers
{
    public sealed class MatchIssues : IEquatable<MatchIssues>, IReadOnlyList<BaseIssue>
    {
        ...
        public int Count => this.issues.Count;
        ...
        public bool Equals([AllowNull] MatchIssues other) 
            => !(other is null) && (ReferenceEquals(this, other) || this.issues.SequenceEqual(other.issues));
